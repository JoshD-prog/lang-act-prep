...
<p class="mt-4 max-w-3xl text-lg text-slate-600">
  Compare upcoming course dates, meeting times, and location details below. Each course includes four focused 90-minute sessions built to sharpen strategy, pacing, and high-yield review before test day.
</p>
</section>
...
<p class="mt-3 text-3xl font-black text-sky">
